...
import com.example.messaging.databinding.MessagingItemContainerReceivedMessageBinding;
import com.example.messaging.databinding.MessagingItemContainerSentMessageBinding;
import com.example.messaging.models.ChatMessage;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        SentMessageViewHolder(MessagingItemContainerSentMessageBinding itemContainerSentMessageBinding)
        {
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ReceivedMessageViewHolder(MessagingItemContainerReceivedMessageBinding messagingItemContainerReceivedMessageBinding)
        {
